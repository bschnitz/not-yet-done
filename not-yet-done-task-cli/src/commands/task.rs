...
pub mod cli {
    ...
    /// Add a new task
    #[command(about = "Add a new task (optionally under a parent, with a project/tag)")]
    pub fn add(
    ...
    /// List tasks
    #[command(about = "List tasks, optionally filtered by project")]
    pub fn list(
    ...
    /// Examples:
    ///   nyd-t tasktree <id>
    ///   nyd-t tasktree <id> --last-tracked-since "2026-04-01"
    #[command(about = "Export a task subtree as nested JSON")]
    pub fn tree(
    ...
    ///
    /// Examples:
    ///   nyd-t taskshow --path /Work/Clients/Acme/Tickets
    ...
    /// Edit a task
    #[command(about = "Edit a task's description, project or tag assignments")]
    pub fn edit(
        #[arg(help = "Task ID")] id: String,
