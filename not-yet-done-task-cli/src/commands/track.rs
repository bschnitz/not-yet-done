...
pub mod cli {
    ...
    /// Examples:
    ///   nyd-t tracksummary
    ///   nyd-t tracksummary --from 2026-03-01 --to 2026-03-22
    ///   nyd-t tracksummary --from 2026-03-01
    #[command(about = "Summarise tracked time per task over an optional date range")]
    pub fn summary(
        #[arg(
            long,
    ...
    ///
    /// Examples:
    ///   nyd-t trackmove <id> "yesterday 9am"
    ///   nyd-t trackmove <id> "2026-03-22" --gravity end
    ///   nyd-t trackmove <id> "today" --gravity start --offset +1h
    ...
    ///
    /// Examples:
    ///   nyd-t trackexport <id1> <id2>
    ///   nyd-t trackexport --from "last monday" --to "today"
    ///   nyd-t trackexport --task-id <uuid> --sort-by-started-at asc
