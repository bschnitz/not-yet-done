...
pub mod cli {
    ...
    #[command(about = "Create a tag (global, or project-specific) with optional colours/symbol")]
    pub fn add(
    ...
    /// List tags
    #[command(about = "List tags (all, global-only with --global, or for a --project)")]
    pub fn list(
    ...
    #[command(about = "Edit a tag's name, colours or symbol (empty string clears a field)")]
    pub fn edit(
    ...
    #[command(about = "Create a tag interactively in $EDITOR (YAML template)")]
    pub fn new() -> u8 {
    ...
    ///   global-tag:<uuid>   for global tags
    ///   project-tag:<uuid>  for project-specific tags
    #[command(about = "Delete a tag by ID (global-tag:<uuid> or project-tag:<uuid>)")]
    pub fn delete(
        #[arg(help = "Tag ID (global-tag:<uuid> or project-tag:<uuid>)")] id: String,
    ) -> u8 {
